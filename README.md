...
- 📋 **Three ways to feed an image** — VS Code panel paste (Trae-style) / screenshot auto-save / direct path
...
# install to a fixed dir so the unzip folder can be deleted: node setup.mjs --install
